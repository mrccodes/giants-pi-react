...
export const getSchedule = async (
    ...
    const url = `https://statsapi.mlb.com/api/v1/schedule?sportId=1&teamId=${team.id}&startDate=${startDate.format(apiDateFormat)}&endDate=${endDate.format(apiDateFormat)}`
    try {
